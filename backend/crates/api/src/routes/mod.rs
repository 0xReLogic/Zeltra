...
#[openapi(
    ...
    components(
        schemas(
            ...
            zeltra_shared::auth::RegisterRequest,
            zeltra_shared::auth::RefreshRequest,
            zeltra_shared::auth::VerifyEmailRequest,
            zeltra_shared::auth::ResendVerificationRequest,
